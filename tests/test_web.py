...
class TestPortada(unittest.TestCase):
    ...
    def test_los_grupos_son_los_pedidos(self):
        """Konami en su grupo; Ale Hop!, Temptations, Colt 36 y Demonia en los
        exclusivos de MSX; el resto en las conversiones. Y ninguno vacio."""
        mi = modulo()
        mi.comprueba()
        ...
        exclusivos = {"alehop", "temptations", "colt36", "demonia"}
